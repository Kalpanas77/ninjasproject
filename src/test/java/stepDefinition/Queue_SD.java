...
public class Queue_SD {
	...
	public void user_is_on_implementation_of_queue_in_python() {
		logger_log4j.info("----------User is on Implementation of Queue in Python------------------------");
	}

	@When("User clicks on Try here button")
	public void user_clicks_on_try_here_button() {
		logger_log4j.info("----------User clicks on TRYHERE button------------------------");
		Qpom.try_button();
	...
	public void user_is_navigated_to_try_editor_page() {
	    logger_log4j.info("----------User is navigated to tryEditor Page------------------------");
	}
	...
	public void user_enters_in_the_editor(String string) {
		logger_log4j.info("----------User Enters Code in Editor------------------------");
	...
	public void clicks_on_run_button() {
		...
		logger_log4j.info("----------clicks on Run Button------------------------");
		Qpom.run_but();
	}
	@Then("The User is Presented with a Result")
	public void the_user_is_presented_with_a_result() {
		logger_log4j.info("----------The User is Presented with a Result------------------------");
	    Qpom.result();
	}
	...
	public void user_is_navigated_to_Implementation_of_queue_in_python() {
	    ...
	    logger_log4j.info("----------User is navigated to Implementation of Queue in python------------------------");
	}
	...
	public void user_clicks_on_the_implementation_using_collections_deque_link() {
		...
		logger_log4j.info("----------User clicks on the Implementation using collections.deque link------------------------");
		Qpom.call_que_colln();	  
	}
	...
	public void user_is_navigated_to_implementation_using_collections_deque_link() {
		logger_log4j.info("----------User is navigated to Implementation using collections.deque link-----------------------");
	}
